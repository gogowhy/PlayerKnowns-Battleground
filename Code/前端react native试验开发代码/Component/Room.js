...
export default class Room extends Component {
    ...
    ConnectWebSocket() {
        ...
        this.ws.onopen = () => {
            ...
            else this.setState({ socketState: WebSocket.OPEN })
        };

        this.ws.onmessage = (e) => {
            // a message was received
            if (this.state.socketState !== WebSocket.OPEN) return;
            console.log(e.data);
            ...
            switch (res.code) {
                ...
                case NEW_PLAYER_JOIN: {
                    ...
                    alert(JSON.stringify(newplayers));
                    this.setState(
                        { players: newplayers }
                    )
                    break;
    ...
    render() {
        ...
        const T = (this.state.team == 2) ? "B->A" : "A->B"; //更换队伍按钮的文字说明
