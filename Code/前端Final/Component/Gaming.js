...
export default class Gaming extends Component {
    ...
    constructor(props) {
        ...
        this.GunViewModePic = {
            "AK-47": require('../src/img/guns/AK47view.png'),
            "AKM": require('../src/img/guns/AKMview.png'),
            "M16": require('../src/img/guns/M16view.png'),
            "M4A1": require('../src/img/guns/M4A1view.png'),
            "M14EBR": require('../src/img/guns/M14EBRview.png'),
            "scar-L": require('../src/img/guns/SCARview.png'),
            "QBZ95": require('../src/img/guns/QBZ95view.png'),
            "Win94": require('../src/img/guns/Win94view.png'),
            "VSS": require('../src/img/guns/VSSview.png'),
            "s686": require('../src/img/guns/s686view.png'),
            "s1897": require('../src/img/guns/S1897view.png'),
            "Micro UZI": require('../src/img/guns/Microuziview.png'),
            "UMP9": require('../src/img/guns/ump9view.png'),
            "Vector": require('../src/img/guns/Vectorview.png'),
            "AWM": require('../src/img/guns/AWMview.png'),
            "98K": require('../src/img/guns/98Kview.png'),
            "BarrettM82A1": require('../src/img/guns/BarrettM82A1view.png'),
            "RPG": require('../src/img/guns/RPGview.png'),
        }
    }
                ...
                <View style={styles.container}>
                    ...
                    <View style={StyleSheet.absoluteFill}>
                        ...
                        <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end' }}>
                            ...
                            <Image source={this.GunViewModePic[this.state.gun]} style={{ width: 180, height: 150, resizeMode: 'contain', justifyContent: 'center' }}></Image>
